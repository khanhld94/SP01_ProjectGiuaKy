<section class="itq-tabs">
	...
	<ul>
		...
		<li class="active"><a href="<?php echo site_url('backend_article/post/add');?>">Thêm mới</a></li>
	</ul>
</section><!-- .itq-tabs -->
	...
	<section class="main-panel">
		...
		<section class="block">
			...
			<label class="item">
				...
				<?php echo form_dropdown('catalogueid', $dropdown_catalogueid, set_value('catalogueid', 0), ' class="cbSelect"');?>
			</label>
			<label class="item">
			...
			<label class="item">
				...
				<textarea name="content" class="txtTextarea wysiwygEditorContent" id="txtContent"><?php echo set_value('content', '');?></textarea>
			</label>
